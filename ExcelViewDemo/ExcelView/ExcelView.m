...
#include <math.h>
@interface ExcelView ()<deleteHomeSecond>
...
- (void)touchhomeSecond:(ExcelLockCell *)SecondcellView cellNumber:(int)CellNumber didSelectItemAtIndex:(int)index
{
    if([self.delegatehomefrist  respondsToSelector:@selector(touchhomefrist:cellNumber:didSelectItemAtIndex:)])
    {
        [self.delegatehomefrist touchhomefrist:self cellNumber:CellNumber didSelectItemAtIndex:index];
    }
}
